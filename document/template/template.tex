...
% -------------------------------------------------------------------
% Font configuration via Pandoc variables
% (template expansion happens here, unlike in header.tex)
% -------------------------------------------------------------------
$if(mainfont)$
  \ifLuaTeX
    \usepackage{fontspec}
...
$if(mathfont)$
  ...
  \else
    % For XeLaTeX we typically load unicode-math too, but keep it minimal
    \usepackage{unicode-math}
    \setmathfont{$mathfont$}
  \fi
$endif$
